...
| 2026-09-05 | **Correction to the 11.75 figure quoted above and at 11.83.** A blind recount of `gate-triage-reads/rater-a.json` and `rater-b.json` against the band tags in `gate-triage.json` gives the eligible band as **five connotation, three taxonomy** (*irrelevant*, *unfavorable*, *competitive*). The sentence "five of eight judged taxonomy" reached that count by adding *inaccurate* and *genuine*, which are hand-picked controls, not eligible families. The gate selects connotation five times in eight - 0.62 against the hand-picked corpus's 0.58 - and the same results file already said so in `findings[2]`. What survives: roughly 40% of tick effort (3/8) goes to taxonomy, and the threshold should not be lowered. What does not: the gate as a proxy that mostly picks taxonomy, and the demotion of the adjective queue to filler that was argued from it. |
...
> **Corrected 2026-09-05.** A blind recount of `gate-triage-reads/rater-a.json` and `rater-b.json` against the band tags in `gate-triage.json` gives the eligible band as **five connotation, three taxonomy** (*irrelevant*, *unfavorable*, *competitive*). The sentence "five of eight judged taxonomy" reached that count by adding *inaccurate* and *genuine*, which are hand-picked controls, not eligible families. The gate selects connotation five times in eight - 0.62 against the hand-picked corpus's 0.58 - and the same results file already said so in `findings[2]`. What survives: roughly 40% of tick effort (3/8) goes to taxonomy, and the threshold should not be lowered. What does not: the gate as a proxy that mostly picks taxonomy, and the demotion of the adjective queue to filler that was argued from it.
